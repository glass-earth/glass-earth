...
namespace Networking
{
		public class NetworkManager : MonoBehaviour
		{
			...
			Debug.Log ("show land temp");
						EarthController.GetComponent<EarthMeterialChanger> ().ShowLandTemp ();
				}

				void ShowEarth ()
				{
						EarthController.GetComponent<EarthMeterialChanger> ().ShowEarth ();
				}

				void RotateLeft ()
				{
						CameraController.GetComponent<CameraController> ().RotateLeft (0);
				}
				...
				void TimeForward ()
				{
						var d = EarthController.GetComponent<EarthMeterialChanger> ().getCurIndex ();
						var d2 = d + 1;
						d2 = d2 < 0 ? 0 : d2;
						d2 = d2 >= maxTime ? maxTime : d2;
						EarthController.GetComponent<EarthMeterialChanger> ().SetTexIndex (d2);
				}
